...
func (p *BitgetRestClient) Init() *BitgetRestClient {
	p.ApiKey = os.Getenv("BITGET_API_KEY")          //config.ApiKey
	p.ApiSecretKey = os.Getenv("BITGET_API_SECRET") //config.SecretKey
	p.BaseUrl = config.BaseUrl
	p.Passphrase = os.Getenv("BITGET_API_PASS") //config.PASSPHRASE
